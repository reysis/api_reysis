...
const Stats = (props) => (
    <div className="">
        <Row>
            <Col lg={2} sm={12}>
                { props.step > 1 &&
                <button className='btn btn-primary btn-block' onClick={props.previousStep}>Ir Atras</button>
                }
            </Col>
            <Col lg={8} sm={12}/>
            <Col lg={2} sm={12}>
                { props.step < props.totalSteps ?
                    <button className='btn btn-primary btn-block' onClick={props.nextStep} disabled={props.disabledNext}>Siguiente</button>
                    :
            ...
            <Row>
                ...
                <Col lg={6} sm={12}>
                    ...
                    <Form.Control value={props.servicio} onChange={props.handleChangeServicio} as="select" id="servicios">
                        <option>Escoja el servicio...</option>
                        {props.servicios}
                    </Form.Control>
                </Col>
            </Row>
            <Stats step={1} {...props} disabledNext={props.disabledNext} />
        </div>
    );
};
            ...
            <Card className="text-center">
                ...
                <Card.Body>
                    ...
                    <Row>
                        <Col>
                            <Label>Fecha: </Label>
                            <span> <strong>{props.fecha.getDay()+"/" + (props.fecha.getMonth() + 1) + "/" + props.fecha.getFullYear() + " " + props.time + " " + props.seccionDelDia}</strong></span>
                        </Col>
                    </Row>
            ...
            <Row>
                <Col lg={6} sm={12} className="p-2">
                    <div className="p-2">
                        ...
                        <Form.Control value={props.taller} onChange={(e)=>props.setTaller(e.target.value)} as="select" id="servicios">
                            <option>Escoja el Taller...</option>
                            {props.arrayTallers}
                        </Form.Control>
                    </div>
                    <div className="p-2">
