 ...
 */
final class Version20200926203215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE turno ADD persona_citada VARCHAR(255) NOT NULL, DROP persona_citada_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE turno ADD persona_citada_id INT NOT NULL, DROP persona_citada');
